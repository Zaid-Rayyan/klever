...
<body>
    <header>
        <div class="upperHeader">
            ...
            <div class="cart"><a href="HTML/Cart.php"><img src="Images/sliders/Cart.png" alt="" id="cartI"></a>
        ...
        <nav class="navBar">
            ...
            <ul id="navLinks">
                ...
                <li id="link"><a href="#product">Products</a></li>
                <li id="link"><a href="HTML/About-Us.php">About Us</a></li>
                <li id="link"><a href="HTML/FAQ.php">FAQ</a></li>
                <li id="link"><a href="HTML/Contact-Us.php">Contact Us</a></li>
            </ul>
        </nav>
        <script>
            function myFunction() {
